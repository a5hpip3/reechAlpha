...
class User < ActiveRecord::Base
	...
	attr_accessible :email,:phone_number ,:password, :password_confirmation, :remember_me, :group_ids, :user_profile_attributes, :invite_code, :invite_id, :audien_details, :device, :picture
